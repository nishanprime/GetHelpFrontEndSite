...
function body() {
      ...
      <div className="card-body">
        <div className="d-flex flex-column align-items-center text-center">
          ...
          <div className="mt-3">
            ...
            <button className="btn btn-outline-primary">Emergency Hospital</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div className="col-md-8">
   ...
   <div>
      <Card>
        <CardImg top width="100%" style={{height:"40px",width:"40px",marginLeft:"20px"}} src="https://icons-for-free.com/iconfiles/png/512/emergency+light+police+icon-1320190828028396427.png" alt="Card image cap" />
        <CardBody>
          <CardTitle tag="h5">Emergency Notes</CardTitle>
          <CardSubtitle tag="h6" className="mb-2 text-muted">Put what to do noext info from emergency here</CardSubtitle>
